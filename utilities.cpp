...
// trueWithProbability, which takes an argument that represents a probability p. The function picks a random bool
// value to return: With probability p, it picks true, and with probability 1-p it picks false.
...
//getCharacter, to get a character from the keyboard without waiting for a newline and without echoing the character
// to the screen. The directional keys h, j, k, and l, as well as the arrow keys, are mapped to constants ARROW_LEFT,
// ARROW_RIGHT, etc.
char getCharacter()
{
